# Usage:
# $ NIXOS_CONFIG=`pwd`/nixos/modules/virtualisation/openstack-image.nix
...

{
  system.build.OpenStackImage = import ../../lib/make-disk-image.nix {
    ...
    configFile = pkgs.writeText "configuration.nix"
      ''
        {
          imports = [ <nixpkgs/nixos/modules/virtualisation/openstack-image.nix> ];
        }
      '';
  };
  ...
  # Enable cloud-init, since this is a standalone image, uncoordinated by e.g.
  # nixops or other tooling.
